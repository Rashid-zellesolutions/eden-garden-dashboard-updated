...
const BackdropTable = () => {
  ...
  const [isBackdropAddVisible, setBackdropAddVisible] = useState(false);
  const [backdropFormData, setBackdropFormData] = useState({ name: '', cost: '', description: '', backDropImage: '' });
...

    {
      !isBackdropAddVisible ?
        <Button type="primary" htmlType="submit"
          ...
          onClick={addBackdrop}
        >
          Add Backdrop or Mandap
        </Button> : <div style={{ width: '100%', padding: '10px' }}>
          <form style={{ width: '100%' }} onSubmit={backdropSelectionSubmit}>
            <div style={{ width: '100%', display: 'flex', gap: '15px', marginTop: '20px' }}>
              ...
              <InputField
                ...
                value={backdropFormData.description}
                onChange={handleBackdropSelectionChange}
              />
              <InputField
                width={'33%'}
